    ...
    if args.data == 'cifar':
        ...
        train_dataset = datasets.CIFAR10('data', train=True, 
            transform=transforms.Compose([
                transforms.RandomResizedCrop(32), #was 224 - When using a cifar model, the images should be size 32 oops
        ...
        val_dataset = datasets.CIFAR10('data', train=False, 
            transform=transforms.Compose([
                transforms.Resize(32), #was 256
                transforms.CenterCrop(32), #was 224
                transforms.ToTensor(),
                normalize,
            ]),
            download=True)
